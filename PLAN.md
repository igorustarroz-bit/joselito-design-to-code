...
Con UI08, UI09 y UI10 completados, la cadena de checkboxes está terminada. Seguir con **UI11 · Form**, después UI12 · Tag, UI13 · Accordion, UI14 · Placeholder Text, Title, Card Product, Card Link, Card Carrusel, y por último los 27 módulos empezando por "Content / Text + Image" (referencia de calidad marcada en las instrucciones del proyecto).
