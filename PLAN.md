...
Con UI12 · Tag completado, seguir con **UI13 · Accordion**, después UI14 · Placeholder Text, Title, Card Product, Card Link, Card Carrusel, y por último los 27 módulos empezando por "Content / Text + Image" (referencia de calidad marcada en las instrucciones del proyecto).
