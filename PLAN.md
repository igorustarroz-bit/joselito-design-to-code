...
Seguir con **UI08 · Checkbox List** (depende de UI09, ya completado). Se reordenó la construcción respecto al orden en que aparecen listados arriba, siguiendo la propia regla del proyecto de construir primero las piezas base. Después continuar con UI11 · Form, UI12 · Tag, UI13 · Accordion, UI14 · Placeholder Text, Title, Card Product, Card Link, Card Carrusel, y por último los 27 módulos empezando por "Content / Text + Image" (referencia de calidad marcada en las instrucciones del proyecto).
