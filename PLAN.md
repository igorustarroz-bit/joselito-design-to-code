...
Seguir con **UI09 · Checkbox + Label** (depende de UI10, ya completado) y después **UI08 · Checkbox List** (depende de UI09). Se reordenó la construcción respecto al orden en que aparecen listados arriba, siguiendo la propia regla del proyecto de construir primero las piezas base.
